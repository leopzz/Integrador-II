...
function Bebida() {
    ...
    const CarregarGrid = async (dados) => {
        await axios.post("http://localhost:3000/Bebidas/ObterGridPesquisa", dados).then((res) => {
    ...
    const salvarClick = async () => {
        ...
        console.log(dados)
        await axios.post("http://localhost:3000/Bebidas/Salvar", dados).then((res) => {
    ...
    const preencherCadastro = async (e) => {
        ...
        await axios.post("http://localhost:3000/Bebidas/BuscarPorCodigo", { Codigo: e.target.id }).then((res) => {
            var data = res.data.Data;
            setDescricao(data.ds_bebida);
            setStatus(data.sn_ativo);
            setId(data.id_bebida);
                ...
                <Col md={10} style={{ justifyContent: "center", display: "flex" }}>
                    <Col md={11}>
                        ...
                        <Row md={12} style={{ marginBottom: "2rem", marginTop: "1rem" }}>
                            <h2 style={{ marginBottom: "1rem", color: "#fff" }}>Bebidas</h2>
