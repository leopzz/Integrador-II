...
function Prato() {
    ...
    const CarregarGrid = async (dados) => {
        await axios.post("http://localhost:3000/Pratos/ObterGridPesquisa", dados).then((res) => {
    ...
    const salvarClick = async () => {
        ...
        console.log(dados)
        await axios.post("http://localhost:3000/Pratos/Salvar", dados).then((res) => {
    ...
    const preencherCadastro = async (e) => {
        ...
        await axios.post("http://localhost:3000/Pratos/BuscarPorCodigo", { Codigo: e.target.id }).then((res) => {
            var data = res.data.Data;
            setDescricao(data.ds_prato);
                ...
                <Col md={10} style={{ justifyContent: "center", display: "flex" }}>
                    <Col md={11}>
                        ...
                        <Row md={12} style={{ marginBottom: "2rem", marginTop: "1rem" }}>
                            <h2 style={{ marginBottom: "1rem", color: "#fff" }}>Pratos</h2>
