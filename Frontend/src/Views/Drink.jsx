...
function Drink() {
    ...
    const CarregarGrid = async (dados) => {
        await axios.post("http://localhost:3000/Drinks/ObterGridPesquisa", dados).then((res) => {
    ...
    const salvarClick = async () => {
        ...
        console.log(dados)
        await axios.post("http://localhost:3000/Drinks/Salvar", dados).then((res) => {
    ...
    const preencherCadastro = async (e) => {
        ...
        await axios.post("http://localhost:3000/Drinks/BuscarPorCodigo", { Codigo: e.target.id }).then((res) => {
            var data = res.data.Data;
            setDescricao(data.ds_drink);
                ...
                <Col md={10} style={{ justifyContent: "center", display: "flex" }}>
                    <Col md={11}>
                        ...
                        <Row md={12} style={{ marginBottom: "2rem", marginTop: "1rem" }}>
                            <h2 style={{ marginBottom: "1rem", color: "#fff" }}>Drinks</h2>
